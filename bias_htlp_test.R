...
parameter_estimates_1_2_05[,c(14,15,16)] = log(parameter_estimates_1_2_05[,c(14,15,16)]/(1-parameter_estimates_1_2_05[,c(14,15,16)]))
...
p11 <- ggplot(df, aes(sample = V11)) + geom_qq(size=1) + geom_qq_line() + theme_classic(base_size=10) + xlab("Theoretical") + ylab("Sample") + ggtitle(expression(paste("log(",tau[1],")")))
p12 <- ggplot(df, aes(sample = V12)) + geom_qq(size=1) + geom_qq_line() + theme_classic(base_size=10) + xlab("Theoretical") + ylab("Sample") + ggtitle(expression(paste("log(",tau[2],")")))
p13 <- ggplot(df, aes(sample = V13)) + geom_qq(size=1) + geom_qq_line() + theme_classic(base_size=10) + xlab("Theoretical") + ylab("Sample") + ggtitle(expression(paste("log(",tau[3],")")))
p14 <- ggplot(df, aes(sample = V14)) + geom_qq(size=1) + geom_qq_line() + theme_classic(base_size=10) + xlab("Theoretical") + ylab("Sample") + ggtitle(expression(paste("log(",kappa[1],"/(1-",kappa[1],"))")))
p15 <- ggplot(df, aes(sample = V15)) + geom_qq(size=1) + geom_qq_line() + theme_classic(base_size=10) + xlab("Theoretical") + ylab("Sample") + ggtitle(expression(paste("log(",kappa[1],"/(1-",kappa[2],"))")))
p16 <- ggplot(df, aes(sample = V16)) + geom_qq(size=1) + geom_qq_line() + theme_classic(base_size=10) + xlab("Theoretical") + ylab("Sample") + ggtitle(expression(paste("log(",kappa[1],"/(1-",kappa[3],"))")))
pdf(file="C:/Users/henri/Documents/GitHub/Master-Thesis/Images/Case2_05_qq_htlp.pdf")
