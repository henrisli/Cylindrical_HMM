...
for (iter in 1:n_start){
  ...
  theta_list[[iter]][,1] = runif(ncolor,0.9,3) # 0.9-3
  theta_list[[iter]][,2] = runif(ncolor,5,25) # 5-25
...
write.table(optimal$par, "C://Users//henri//Documents//GitHub//Master-Thesis//Data//parameter_estimates_sinmod_3.csv")
...
# estimated_param[c(22,23,24,25,26)] = tanh(optimal$par[c(22,23,24,25,26)])
