...
for (rep_num in 1:n_replicates){
  ...
  write.table(parameter_estimates_1[1:rep_num,], "C://Users//henri//Documents//GitHub//Master-Thesis//Data//parameter_estimates_case2_08.csv")
  print(rep_num)
}
...
apply(parameter_estimates_1, 2, mean)
...
#pdf(file="C:/Users/henri/Documents/GitHub/Master-Thesis/Images/Case2_08_bias_weissvm.pdf")
